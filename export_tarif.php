        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="tarif.php" style="color: #939393;">Data Tarif</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #ADADAD; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Tarif</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
            ...
            <!-- /.card -->
            <a href='tarif.php' class="btn btn-primary btn-sm">Tutup</a>
              <!-- /.card-header -->
