...
if (isset($_GET['kode_tarif'])) {
    $kode_tarif = $_GET['kode_tarif'];

    // query hapus
    $query = "DELETE FROM tbtarif WHERE kode_tarif=$kode_tarif";
    ...
    <!-- Content Header (Page header) -->
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <a href='create_tarif.php' class="btn btn-secondary" style="margin-left: 10px;"><img src="gambar/plus.png" width="18px" height="18px">&nbsp;Tarif Baru</a>&nbsp;<a href='export_tarif.php' class="btn btn-dark"><img src="gambar/export.png" width="18px" height="18px">&nbsp;Export Data</a><br>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #E2E2E2; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Tarif</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="datatablesSimple"class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                        $no = 0;
                        $tabel = mysqli_query($conn, "SELECT * FROM tbtarif ORDER BY abonemen asc");
                        ...
                        <tr>
                            ...
                            <td><?php echo $data['pemakaian_min']; ?></td>
                            <td><?php echo $data['pemakaian_max']; ?></td>
                            <td><?php echo $data['jumlah_tarif']; ?></td>
                            <td><?php echo $data['abonemen']; ?></td>
                            <td><a href='tarif.php?kode_tarif="<?=$data['kode_tarif']?>"' class="btn btn-danger btn-sm" onclick="return confirm('apakah anda yakin untuk menghapus?')">Hapus</a></td>
                            <td><a href='edit_tarif.php?kode_tarif="<?=$data['kode_tarif']?>"' class="btn btn-warning btn-sm">Edit</a></td>
                        </tr>
                        <?php
                        }
                        ?>
