...
<html>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                	...
                	<div class="box box-solid no-print">
						<div class="box-header" >							
							<div class="form-group"><br>								
								...
								<div class="col-lg-6">
									<select class="form-control" id="cboblntrx">
				...
				<section class="content invoice">
					<div class="row">                       
						<label class="col-xs-12 control-label" style="font-family: 'calibri';"><?php echo $_SESSION[perusahaan]; ?></label>
						<span class="col-xs-12 control-label" style="font-family: 'calibri';" id="lblarea">Cabang Slamet Riyadi </span>		
						<span class="col-xs-12 control-label" style="font-family: 'calibri';" id="lblalamat">Pertokoan Jl. Slamet Riyadi</span>                    
					</div><hr><br>		
					...
					<div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            <center>
                                <strong>REKAP PENJUALAN</strong><br>
                                <span id='lbltgltrx'>Bln. Oktober 2016</span>
                            </center>
                        </div>
                        <div class="col-sm-4 invoice-col"></div>
                    </div><br>
		...
		<script src="js/rekapjual.js"></script>
