        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="user_apk.php" style="color: #939393;">Pengguna Aplikasi</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #ADADAD; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Pengguna&nbsp;&nbsp;Aplikasi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
            ...
            <!-- /.card -->
            <a href='user_apk.php' class="btn btn-primary btn-sm">Tutup</a>
              <!-- /.card-header -->
