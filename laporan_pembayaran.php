...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="laporan_pembayaran.php" style="color: #E2E2E2;">Laporan Pembayaran</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
	...
	<div class="container">
				...
				<a href='export_laporan_pembayaran.php' class="btn btn-secondary" style="margin-left: 15px;"><img src="gambar/export.png" width="18px" height="18px">&nbsp;Export Data</a><br><br>
