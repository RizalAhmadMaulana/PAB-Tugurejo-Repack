...
$query = "SELECT * FROM tbtarif WHERE kode_tarif=$kode_tarif";
...
if (isset($_POST['submit'])){
    ...
    // buat query update
    $query = "UPDATE tbtarif SET kode_tarif='$kode_tarif', pemakaian_min='$pemakaian_min', pemakaian_max='$pemakaian_max', jumlah_tarif='$jumlah_tarif', abonemen='$abonemen' WHERE kode_tarif=$kode_tarif";
    $sql = mysqli_query($conn, $query);
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="tarif.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Tarif</p>
                </a>
              </li>
              ...
              <form method="post" action="">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="KodeTarif" required autocomplete="off" id="exampleInputEmail1" placeholder="Masukkan kode Anda" value="<?php echo $data['kode_tarif']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Pemakaian Minimal :</label>
                    <input type="number" class="form-control" name="PemakaianMinimal" required autocomplete="off" id="exampleInputEmail1" placeholder="Masukkan Pemakaian Minimal Anda" value="<?php echo $data['pemakaian_min']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Pemakaian Maksimal :</label>
                    <input type="number" class="form-control"name="PemakaianMaksimal" required autocomplete="off" id="exampleInputEmail1" placeholder="Masukkan Pemakaian Maksimal anda" value="<?php echo $data['pemakaian_max']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Jumlah Tarif :</label>
                    <input type="number" class="form-control" name="JumlahTarif" required autocomplete="off" id="exampleInputEmail1" placeholder="Masukkan Jumlah Tarif Anda" value="<?php echo $data['jumlah_tarif']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Abonemen :</label>
                    <input type="text" class="form-control" name="Abonemen" required readonly autocomplete="off" id="exampleInputEmail1" value="<?php echo $data['abonemen']; ?>">
                  </div>
                </div>
                <!-- /.card-body -->
